...
# sugarcube-3.py
#
# Copyright (c) 2013-2020 Thomas Michael Edwards <thomasmedwards@gmail.com>. All rights reserved.
...
class Header (header.Header):
	...
	def storySettings(self):
		return "SugarCube 3.x does not support the StorySettings special passage.\n\nInstead, you should use its configuration object, Config.\n    See: http://www.motoslave.net/sugarcube/3/docs/#config-api"
